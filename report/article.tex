...
A Tabela~\ref{tab:valores} apresenta os valores médios obtidos para arquivos de 25MB, representando o comportamento típico em arquivos de tamanho moderado.

\begin{table}[h]
  \centering
  \caption{Valores médios para arquivos de 25MB (3 execuções).}
  \label{tab:valores}
  \begin{tabular}{lcccc}
    \toprule
    \textbf{Algoritmo} & \textbf{Compressão (s)} & \textbf{Descompressão (s)} & \textbf{Taxa (\%)} & \textbf{Tamanho Final} \\
    \midrule
    gzip & 2,79 & 0,25 & 37,34 & 9,3 MB \\
    bzip2 & 3,33 & 1,68 & 21,52 & 5,4 MB \\
    xz & 21,53 & 0,21 & 10,12 & 2,5 MB \\
    zstd & 0,26 & 0,07 & 23,56 & 5,9 MB \\
    \bottomrule
  \end{tabular}
\end{table}
